namespace ChickenProtector.Spatials
{
    ...
    internal static class Mosquito
    {
        ...
        public static void Render(SpriteBatch spriteBatch, ContentManager contentManager, TransformComponent transformComponent)
        {
            ...
            spriteBatch.Draw(mosquito, new Vector2(transformComponent.X - (mosquito.Width * 0.5f), transformComponent.Y - (mosquito.Height * 0.5f)), mosquito.Bounds, Color.White, 0, Vector2.Zero, 1, SpriteEffects.None, 0.8f);
        }
    }
}
